...
// general
#define get_global_id(dim) (0) // global index, set x=0
#define get_global_size(x) (0) // global range, set x=0
#define get_local_id(x) (0) // local index within group, set x=0
#define get_local_size(x) (0) // group size, set x=0
#define	get_num_groups(x) (0) // number of groups, set x=0
#define get_group_id(x) (0) // group ID, set x=0
#define get_global_offset(x) (0) // global offset, set x=0
#define get_work_dim (0) // number of dimensions in use
